    ...
    return (
        <div className="bg-white max-w-4xl flex items-center mx-auto md:min-h-screen p-4">
            <div className="grid md:grid-cols-3 items-center [box-shadow:0_2px_10px_-3px_rgba(14,14,14,0.3)] rounded-xl overflow-hidden">
                ...
                <form className="md:col-span-2 w-full py-6 px-6 sm:px-14 max-w-lg mx-auto" onSubmit={handleSubmit(onSubmit)}>
                    <div className="mb-8">
                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="relative flex items-center">
                                ...
                                })} type="text" className="text-slate-900 bg-white border border-slate-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter name" />
                        ...
                        <div>
                            ...
                            <div className="relative flex items-center">
                                ...
                                })} type="email" className="text-slate-900 bg-white border border-slate-300 w-full text-sm pl-4 pr-8 py-2.5 rounded-md outline-blue-500" placeholder="Enter email" />
                        ...
                        <div className="flex items-center">
                            <input id="accept" {...register("accept", {
                                required: "Please accept the Terms and Conditions"
                            })} type="checkbox" className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-slate-300 rounded" />
                            <label htmlFor="accept" className="ml-3 block text-sm text-slate-600">
                                I accept the <a href="javascript:void(0);" className="text-blue-600 font-medium hover:underline ml-1">Terms and Conditions</a>
                            </label>
                        </div>
                        {errors.accept && <p className="text-red-500 text-xs -mt-5">{errors.accept.message}</p>}
                    </div>
                    <div className="mt-8">
                    ...
                    <p className="text-slate-600 text-sm mt-6 text-center">Already have an account? <Link to="/sign-in" className="text-blue-600 font-medium hover:underline ml-1">Login here</Link></p>
                </form>
            </div>
        </div>
    );
