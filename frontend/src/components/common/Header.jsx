        ...
        <header className="min-h-[60px] tracking-wide relative z-50">
            ...
            <div className="flex flex-wrap items-center justify-between py-3 px-4 sm:px-10 bg-[#151d20] lg:gap-y-4 gap-y-6 gap-x-4">
                ...
                <div id="collapseMenu" className="max-lg:hidden lg:!flex lg:items-center max-lg:before:fixed max-lg:before:bg-black max-lg:before:opacity-40 max-lg:before:inset-0 max-lg:before:z-50">
                    ...
                    <ul className="lg:!flex lg:gap-x-10 max-lg:space-y-3 max-lg:fixed max-lg:bg-[#151d20] max-lg:w-2/3 max-lg:min-w-[300px] max-lg:top-0 max-lg:left-0 max-lg:px-10 max-lg:py-4 max-lg:h-full max-lg:shadow-md max-lg:overflow-auto z-50 [&>.active]:lg:after:w-full [&>.active]:lg:after:h-0.5 [&>.active]:lg:after:absolute">
                        <li className="mb-6 hidden max-lg:block">
                            <Link to="/" className="text-2xl text-white font-bold">{name}</Link>
                        </li>
                        <NavLink to="/" className="max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:after:bg-white lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300">
                            <span className="text-white block text-[15px] font-normal">Home</span>
                        </NavLink>
                        <NavLink to="/shop" className="max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300">
                            <span className="text-white block text-[15px] font-normal">Shop</span>
                        </NavLink>
                        <NavLink to="/contact" className="max-lg:border-b max-lg:border-gray-100 max-lg:py-3 relative lg:hover:after:absolute lg:after:bg-white lg:after:w-0 lg:hover:after:w-full lg:hover:after:h-[2px] lg:after:block lg:after:-bottom-4 lg:after:transition-all lg:after:duration-300">
                            <span className="text-white block text-[15px] font-normal">Contact</span>
                        </NavLink>
                    </ul>
                </div>
