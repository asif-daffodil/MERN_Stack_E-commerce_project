    ...
    return (
        <footer className="bg-gray-800 py-6  px-8 tracking-wide mt-16">
            <div className="relative max-w-screen-xl mx-auto">
                <div className="bg-blue-600 gap-3 rounded-3xl flex flex-wrap items-center justify-between sm:px-8 max-sm:px-6 py-2 min-h-[100px] absolute top-[-76px] w-full">
                    <h6 className="text-white text-xl font-medium">Kickstart Your Career Today</h6>
                    <button type="button" className="px-6 py-3 text-sm rounded-full text-white gap-2 bg-gray-800 cursor-pointer">Get
                        Started</button>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 pt-20">
                    ...
                    <div>
                        <h4 className="text-base font-medium mb-6 text-slate-100">Services</h4>
                        <ul className="space-y-4">
                            <li><a href="javascript:void(0)" className="text-slate-400 hover:text-slate-200 text-base">Web
                                Development</a></li>
                            <li><a href="javascript:void(0)" className="text-slate-400 hover:text-slate-200 text-base">Mobile App
                                Development</a></li>
                            <li><a href="javascript:void(0)" className="text-slate-400 hover:text-slate-200 text-base">UI/UX
                                Design</a></li>
                            <li><a href="javascript:void(0)" className="text-slate-400 hover:text-slate-200 text-base">Digital
                                Marketing</a></li>
                            <li><a href="javascript:void(0)" className="text-slate-400 hover:text-slate-200 text-base">E-commerce Solutions</a></li>
                            <li><a href="javascript:void(0)" className="text-slate-400 hover:text-slate-200 text-base">Brand Strategy</a></li>
                        </ul>
                    </div>
                    <div>
                    ...
                    <div>
                        <h4 className="text-base font-medium mb-6 text-slate-100">Follow Us</h4>
